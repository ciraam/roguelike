import { Mesh, Clock } from 'https://cdn.jsdelivr.net/npm/three@0.175.0/build/three.module.js'
import materialGrass from '../shader/grass.js'
import materialPlant from '../shader/plant.js'
import { replaceMaterial } from '../tool/function.js'
...
export default class Grass extends Mesh {
  ...
  cut() {
    ...
    this.animation()
    if (Grass.sound.paused) Grass.sound.play(0.1)
    if (Grass.cbCut) {
