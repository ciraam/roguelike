import { Mesh, Vector3 } from 'https://cdn.jsdelivr.net/npm/three@0.175.0/build/three.module.js'
...
import { removeFromArray } from '../tool/function.js'
...
export default class Box extends Mesh {
  ...
  hit(entity) {
    if (this.hp > 0) {
      ...
      this.hp -= 1
      Box.soundHit.play(0.1)
      if (this.hp === 0) {
        Box.soundBreak.play(0.1)
