import { Vector3, PointLight } from 'https://cdn.jsdelivr.net/npm/three@0.175.0/build/three.module.js'
import { Ctrl } from '../control/gamepad.js'
...
export default class Player extends Entity {
  ...
  updatePropsWalk(dt) {
    const maxVelosity = this.veloci * this.ctrl.magnitude
