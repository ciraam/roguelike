import { MathUtils } from 'https://cdn.jsdelivr.net/npm/three@0.175.0/build/three.module.js'
import { clone as cloneSkeleton } from 'three/utils/SkeletonUtils.js'
import Rapier from 'https://cdn.jsdelivr.net/npm/@dimforge/rapier3d-compat@0.11.2/+esm'
// import overwrite from '../tool/overwrite.js'
//  overwrite()
...
export function cleanGameLevel(objects3d, graphic) {
  for (let key in objects3d) {
    const object = objects3d[key]
    if (Array.isArray(object)) {
      for (const obj of object) {
