import { WebGLRenderer, Clock, TextureLoader } from 'https://cdn.jsdelivr.net/npm/three@0.175.0/build/three.module.js'
import { EffectComposer } from 'three/postprocessing/EffectComposer.js'
import { RenderPass } from 'three/postprocessing/RenderPass.js'
import { BokehPass } from 'three/postprocessing/BokehPass.js'
...
import { GTAOPass } from 'three/postprocessing/GTAOPass.js'
import { Mesh, AnimationMixer, AnimationClip, LoopOnce } from 'https://cdn.jsdelivr.net/npm/three@0.175.0/build/three.module.js'
import { createElement, getCanvas } from '../tool/function.js'
...
export default class Graphic extends WebGLRenderer {
  ...
  constructor(scene, camera, fx, canvas) {
